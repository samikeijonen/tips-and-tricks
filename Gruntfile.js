...
grunt.initConfig({
  pkg: grunt.file.readJSON('package.json'),
    ...
    makepot: {
      target: {
        options: {
          ...
          potFilename: 'tips-and-tricks.pot',  // Name of the POT file.
	...
	cssmin : {
		css: {
			src: 'admin/css/tips-and-tricks-admin.css',
			dest: 'admin/css/tips-and-tricks-admin.min.css'
		}
	},
	...
	uglify: {
		admin: {
			files: {
				'admin/js/tips-and-tricks-admin.min.js': ['admin/js/tips-and-tricks-admin.js']
			}
		}
	},
